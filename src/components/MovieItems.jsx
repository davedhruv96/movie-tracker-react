                                        ...
                                        <div class="slick-multiItem">
                                            <div class="slide-it">
                                                <div class="movie-item">
                                                    ...
                                                    <div class="hvr-inner">
                                                        <Link to="movie-details"> Read more <i class="ion-android-arrow-dropright"></i> </Link>
                                                    </div>
                                                    <div class="title-in">
                                        ...
                                        <div class="slick-multiItem">
                                            <div class="slide-it">
                                                <div class="movie-item">
                                                    ...
                                                    <div class="title-in">
                                                        <h6><Link to="movie-details">Interstellar</Link></h6>
                                                        <p><i class="ion-android-star"></i><span>7.4</span> /10</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slide-it">
                                                <div class="movie-item">
                                                    ...
                                                    <div class="title-in">
                                                        <h6><Link to="movie-details">The revenant</Link></h6>
                                                        <p><i class="ion-android-star"></i><span>7.4</span> /10</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slide-it">
                                                <div class="movie-item">
                                                    ...
                                                    <div class="title-in">
                                                        <h6><Link to="movie-details">Die hard</Link></h6>
                                                        <p><i class="ion-android-star"></i><span>7.4</span> /10</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slide-it">
                                                <div class="movie-item">
                                                    ...
                                                    <div class="title-in">
                                                        <h6><Link to="movie-details">The walk</Link></h6>
                                                        <p><i class="ion-android-star"></i><span>7.4</span> /10</p>
                                                    </div>
                                                </div>
                                            </div>
